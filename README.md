...
- Panel `GPT Chat` bên phải để hỏi về note, thêm kết quả vào note, hoặc thay đoạn bôi đen.
...
- Trong panel chat, chọn `Thay đoạn bôi đen` nếu muốn GPT chỉnh sửa đúng đoạn đang chọn.
